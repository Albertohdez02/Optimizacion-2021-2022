...
{
    cout << "Optimiza!cion en Grafos, 2021-2022 ALBERTO HERNANDEZ" << endl;
    cout << "c. [c]argar grafo desde fichero" << endl;
    if (dirigido == 0) //Grafo no dirigido
            {
            cout << "i. Mostrar [i]nformacion basica del grafo" << endl;
            cout << "a. Mostrar la lista de [a]dyacencia del grafo" << endl;
            cout << "m. Realizar un recorrido de a[m]plitud del grafo" << endl;
            cout << "r. Mostrar [r]ecorrido profundidad del grafo" << endl;
            cout << "k. Mostrar el árbol de menor coste por [k]ruskal" << endl;
	    //Aqu� se a�aden m�s opciones al men� del grafo no dirigido
            ...
            cout << "r. Mostrar [r]ecorrido profundidad del grafo" << endl;
            cout << "m. Mostrar recorrido a[m]plitud del grafo" << endl;
            cout << "d. Mostrar caminos mínimos por [D]ijkstra" << endl;
    ...
    else
    {
        ...
        do
        {
            ...
            switch (opcion)
            {
                ...
                case 'r' :
                    clrscr();
                    cout << "Realizando el recorrido de profundidad del grafo" << endl;
                    G.RecorridoProfundidad();
                    break;
                case 'm' : 
                    clrscr();
                    cout << "Realizando recorrido de amplitud del grafo" << endl;
                    G.RecorridoAmplitud();
                    break;
                case 'k' :
                    clrscr();
                    cout << "Hallando el arbol generador de menor coste mediante el algoritmo de Kruskal..." << endl;
                    G.Kruskal();
                    break;
                case 'd' :
                    clrscr();
